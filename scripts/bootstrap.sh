...
ensure_dir "$KNOWLEDGE_DIR/personal/wiki/investing"
ensure_file "$KNOWLEDGE_DIR/personal/wiki/discussions/.gitkeep"
ensure_file "$KNOWLEDGE_DIR/personal/wiki/investing/.gitkeep"
